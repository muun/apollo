...
// infinity.
func Sign(secNonce [musig2.SecNonceSize]byte, privKey *btcec.PrivateKey,
	...
	// nonce:
	//  * b = h(combinedNonce || combinedKey || m). h==sha256
	var (
...
// signed.
func (p *PartialSignature) Verify(pubNonce [musig2.PubNonceSize]byte,
	combinedNonce [musig2.PubNonceSize]byte, keySet []*btcec.PublicKey,
...
func verifyPartialSig(partialSig *PartialSignature, pubNonce [musig2.PubNonceSize]byte,
	combinedNonce [musig2.PubNonceSize]byte, keySet []*btcec.PublicKey,
