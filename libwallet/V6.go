...
func CreateAddressV6(userKey, muunKey *HDPublicKey) (MuunAddress, error) {
	return addresses.CreateAddressV6(&userKey.key, &muunKey.key, userKey.Path, userKey.Network.network)
}
...
func (c *coinV6) SignInput(index int, tx *wire.MsgTx, userKey *HDPrivateKey, muunKey *HDPublicKey) error {
