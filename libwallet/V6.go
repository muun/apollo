...
func (c *coinV6) signFirstWith(
	...
	muunPartialSig, err := musig.ComputeMuunPartialSignature( //nolint:staticcheck // V6 keeps the deprecated flow
		musig.Musig2v100,
		toSign[:],
...
func (c *coinV6) signSecondWith(
	...
	rawCombinedSig, err := musig.ComputeUserPartialSignature( //nolint:staticcheck // V6 keeps the deprecated flow
		musig.Musig2v100,
		toSign[:],
		userPriv.Serialize(),
