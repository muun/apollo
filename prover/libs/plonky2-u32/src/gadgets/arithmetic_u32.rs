...
use crate::gadgets::arithmetic_u32::vec::Vec;
use crate::gadgets::range_check::range_check_u32_circuit;
use crate::gates::add_many_u32::U32AddManyGate;
use crate::gates::arithmetic_u32::U32ArithmeticGate;
use crate::gates::subtraction_u32::U32SubtractionGate;
use crate::serialization::ReadU32;
use crate::serialization::WriteU32;
...
mod tests {
    ...
    pub fn test_range_check() {
        ...
        let u32_unrange = builder.add_virtual_u32_target();

        let u32_order = 0xFFFFFFFF + 1;
        let _ = pw.set_target(u32_unrange.0, F::from_canonical_u64(u32_order));
    ...
    pub fn test_many_range_check() {
        ...
        let u32_targets = builder.add_virtual_u32_targets(2);

        let u32_order = 0xFFFFFFFF + 1;
        pw.set_u32_target(u32_targets[0], 0x00000001);
        let _ = pw.set_target(u32_targets[1].0, F::from_canonical_u64(u32_order));
