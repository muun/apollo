...
class EmergencyKitActivity: SingleFragmentActivity<EmergencyKitPresenter?>(),
                            EmergencyKitView {
    ...
    private fun createStepFragment(step: EmergencyKeysStep): Fragment {
        return when (step) {
            ...
            EmergencyKeysStep.ERROR -> create(
                R.string.export_keys_preparing_error_title,
                R.string.export_keys_preparing_error_desc
            )
        }
    }
}