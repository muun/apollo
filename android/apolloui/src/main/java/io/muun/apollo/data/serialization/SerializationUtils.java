    ...
    static {
        ...
        final SimpleModule simpleModule =
                new SimpleModule("ApolloZonedDateTime serializer/deserializer")
                        ...
                        // Required due to R8 desugaring of static methods in interfaces (like
                        // @JsonCreator static BaseErrorCode.fromValue()), which are not supported
                        // on Android < 24 natively.
                        // TODO Remove this once we reach minSdk 24
                        .addDeserializer(BaseErrorCode.class, new BaseErrorCodeDeserializer());
