...
public class ApplicationLockTest extends BaseTest {
    ...
    public void setUp() {
        ...
        lockManager = new ApplicationLockManager(pinManager, secureStorageProvider);
    ...
    @Test
    public void decrementsRemainingAttempts() {
    ...
    public void errorOnZeroRemainingAttempts() {
