...
public class BitcoinUtils {
    ...
    public static final long MIN_TX_INPUT_SIZE_IN_BYTES = 148; // based on a P2PKH input
    public static final long MIN_TX_OUTPUT_SIZE_IN_BYTES = 34; // based on a P2PKH output
    public static final long MIN_RELAY_TX_FEE_IN_SATOSHIS_PER_KB = 1000; // default in core client

    public static final long MIN_TX_SIZE_IN_BYTES =
            MIN_TX_INPUT_SIZE_IN_BYTES + MIN_TX_OUTPUT_SIZE_IN_BYTES;

    public static final long MIN_FEE_IN_SATOSHIS =
    ...
    public static long bitcoinsToSatoshis(MonetaryAmount bitcoinAmount) {
        ...
        return bitcoinAmount.scaleByPowerOfTen(BITCOIN_PRECISION).getNumber().longValue();
    }
